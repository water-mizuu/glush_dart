...
final class ParseState {
  ...
  final Map<int, List<Frame>> futureWork = {};
  ...
  Step processToken(int unit) {
    ...
    var frames = futureWork.remove(position) ?? [];
    // Every frame pulled from futureWork must be decremented because the
