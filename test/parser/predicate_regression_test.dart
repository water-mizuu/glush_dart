  ...
  group("Predicate Recursion and Isolation Regressions", () {
    test("Original S = &(S S) S S | 's' repro", () {
      ...
      expect(
        result.success(),
        isNotNull,
        reason: "Grammar S = &(S S) S S | 's' should parse 'sss'",
      );
    });
    ...
    test("Mutually recursive rules inside predicates", () {
      ...
      expect(
        result.success(),
        isNotNull,
        reason: "Recursive rules inside lookahead should be stable",
      );
    });
    ...
    test("Isolation: Shared caller between main and predicate", () {
      ...
      expect(
        result.success(),
        isNotNull,
        reason: "Main parse should not be blocked by predicate rule calls",
      );
    });
    ...
    test("Deep nesting level of predicates", () {
      ...
      expect(
        result.success(),
        isNotNull,
        reason: "Deeply nested predicates should resolve normally",
      );
    });
